...
class TokensTest {
    ...
    void test1() {
        ...
        List<String> tokenize = Tokens.tokenize(input);
        assertEquals(8, tokenize.size());
        assertEquals(
                List.of("YES", "leading", "spaces", "are", "valid", "problemsetters", "are", "evillllll"),
                tokenize
        );
    }
    ...
    void test2() {
        ...
        List<String> tokenize = Tokens.tokenize(input);
        assertEquals(475, tokenize.size());
    }
}